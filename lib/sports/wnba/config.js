...
export const wnbaConfig = {
  ...
  teams: {
    ...
    POR: { name: 'Portland Fire',           city: 'Portland',      nickname: 'Fire',       conf: 'West', div: null, primary: '#E93CAC', secondary: '#010101', tertiary: '#C8102E' }, /E93CAC/ corrected Aug 2026 — Pink is the real primary identity color, was missing entirely; Red/Black are the supporting colors (verified via TruColor)
