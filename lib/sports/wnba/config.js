...
export const wnbaConfig = {
  ...
  teams: {
    ATL: { name: 'Atlanta Dream',           city: 'Atlanta',       nickname: 'Dream',      conf: 'East', div: null, primary: '#C8102E', secondary: '#373A36', tertiary: '#418FDE' },
    ...
    LAS: { name: 'Los Angeles Sparks',      city: 'Los Angeles',   nickname: 'Sparks',     conf: 'West', div: null, primary: '#702F8A', secondary: '#FFC72C', tertiary: '#FFFFFF' },
    MIN: { name: 'Minnesota Lynx',          city: 'Minneapolis',   nickname: 'Lynx',       conf: 'West', div: null, primary: '#236192', secondary: '#0C2340', tertiary: '#9EA2A2' },
    ...
    SEA: { name: 'Seattle Storm',           city: 'Seattle',       nickname: 'Storm',      conf: 'West', div: null, primary: '#2C5234', secondary: '#FEE11A', tertiary: '#78BE21' },
  ...
  engine: {
    ...
    roundLabels: { RS: 'Reg. Season', '0.1': "Commissioner's Cup", '1': 'First Round', '2': 'Semifinals', '3': 'WNBA Finals' },
  },
};
