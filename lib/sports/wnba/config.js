...
export const wnbaConfig = {
  ...
  // pairGameRows(). WNBA scores are always comfortably above this.
  ...
  engine: {
    ...
    // See nba/config.js's playoffRoundOrder comment — same mechanism,
    // WNBA's numeric round strings so this reproduces the exact same
    // ranks the old Number(round) parsing already produced.
    playoffRoundOrder: ['1', '2', '3'],
  },
};
