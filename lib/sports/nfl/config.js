...
export const nflConfig = {
  ...
  teams: {
    ...
    OAK: { name: 'Las Vegas Raiders',     city: 'Las Vegas',       nickname: 'Raiders',     conf: 'AFC', div: 'West',  primary: '#A7A8A9', secondary: '#010101', tertiary: '#FFFFFF' },
    ...
    SD:  { name: 'Los Angeles Chargers',  city: 'Inglewood',       nickname: 'Chargers',    conf: 'AFC', div: 'West',  primary: '#0072CE', secondary: '#FFB81C', tertiary: '#FFFFFF' },
    ...
    STL: { name: 'Los Angeles Rams',      city: 'Inglewood',       nickname: 'Rams',        conf: 'NFC', div: 'West',  primary: '#1E22AA', secondary: '#FFD100', tertiary: '#FFFFFF' },
