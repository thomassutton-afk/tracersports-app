...
export const nbaConfig = {
  ...
  teams: {
    ...
    CHA: { name: 'Charlotte Hornets',      city: 'Charlotte',     nickname: 'Hornets',      conf: 'East', div: 'Southeast', primary: '#00778B', secondary: '#1D1160', tertiary: '#FFFFFF' },
    ...
    GS:  { name: 'Golden State Warriors',  city: 'San Francisco', nickname: 'Warriors',     conf: 'West', div: 'Pacific',   primary: '#1D428A', secondary: '#FFC72C', tertiary: '#FFFFFF' },
    ...
    NO:  { name: 'New Orleans Pelicans',   city: 'New Orleans',   nickname: 'Pelicans',     conf: 'West', div: 'Southwest', primary: '#0C2340', secondary: '#B9975B', tertiary: '#C8102E' },
    NY:  { name: 'New York Knicks',        city: 'New York',      nickname: 'Knicks',       conf: 'East', div: 'Atlantic',  primary: '#1D4289', secondary: '#FF8200', tertiary: '#FFFFFF' },
    ...
    SA:  { name: 'San Antonio Spurs',      city: 'San Antonio',   nickname: 'Spurs',        conf: 'West', div: 'Southwest', primary: '#9EA2A2', secondary: '#000000', tertiary: '#FFFFFF' },
  ...
  engine: {
    ...
    roundLabels: { RS: 'Reg. Season', '0.5': 'Play-In', INS: 'In-Season Tourn.', '1': 'Round 1', '2': 'Conf. Semis', '3': 'Conf. Finals', '4': 'NBA Finals' },
  },
};
