...
export const nbaConfig = {
  ...
  teams: {
    ...
    HOU: { name: 'Houston Rockets',        city: 'Houston',       nickname: 'Rockets',      conf: 'West', div: 'Southwest', primary: '#C8102E', secondary: '#FFCD00', tertiary: '#FFFFFF' },
    ...
    SAC: { name: 'Sacramento Kings',       city: 'Sacramento',    nickname: 'Kings',        conf: 'West', div: 'Pacific',   primary: '#010101', secondary: '#582C83', tertiary: '#707372' },
    ...
    UTA: { name: 'Utah Jazz',              city: 'Salt Lake City',nickname: 'Jazz',         conf: 'West', div: 'Northwest', primary: '#330072', secondary: '#7BA4DB', tertiary: '#FFFFFF' },
